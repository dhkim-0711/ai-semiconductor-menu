window.AI_MENU_DATA = {
  "generatedAt": "2026-03-27T05:47:48.299Z",
  "valueChains": [
    {
      "id": "strategy",
      "title": "전략·제도·연계",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "수요·공급·시험인증 연계 협력체계 운영을 통한 국산 NPU 생태계 연결성 제고",
                "정책 공유·현장 애로 해소·수요 발굴·성능지표 고도화 등 허브 기능 동시 추진"
              ]
            },
            {
              "id": "target",
              "label": "지원대상",
              "content": [
                "국내 AI반도체·AI서비스 기업, 수요기관, 공인시험인증기관",
                "정책 협의 및 성능 검증 체계 참여 산학연 주체"
              ]
            },
            {
              "id": "scale",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "K-NPU 얼라이언스·분과 협의 기반 수요-공급 협력 의제 발굴",
                "공인시험인증기관 연계 K-Perf 성능지표 개발·고도화",
                "정책협의·애로 발굴·사업 연계 수요 발굴 등 생태계 소통 기능 수행"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "AI반도체 기업의 자금조달·공공조달 진입 애로 완화를 위한 제도 연계 과제",
                "국민성장펀드·금융 연계 융자·공공조달 항목 신설 등 성장기반 마련 중심"
              ]
            },
            {
              "id": "target",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "국민성장펀드·KIF·금융사 연계 등 직·간접 투자·융자 방식 검토",
                "계약·IP평가 담보형 초저금리 융자 등 NPU 특화 금융지원 체계 연계",
                "공공조달 NPU 품목 신설·혁신제품 지정 및 수요기관 조달 연계 지원"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "국내 AI반도체 기업·스타트업의 설계·제작·검증 전 단계 묶음 지원을 통한 신속 시장 출시 촉진",
                "고비용 설계SW·시제품 제작·양산 고도화·검증체계 활용 등 일괄 지원을 통한 사업화 병목 완화"
              ]
            },
            {
              "id": "target",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "설계SW: 고비용 AI반도체 설계SW 바우처 지원 및 전문 엔지니어 컨설팅",
                "제품제작: MPW 제작비·서버(PCIe) 보드 제작·SW 개발·최적화 지원",
                "양산고도화: 양산 수준 칩·보드 고도화 및 후속 사업화 지원",
                "검증지원: 검증체계 고도화·안정성·신뢰성 검증·설계검증장비 활용"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "다양한 AI모델·서비스 환경 대응 맞춤형 설계 지원을 통한 국산 NPU 안정 동작 기반 마련",
                "설계 IP 활용 지원을 통한 중소 AI반도체 기업 개발 부담 완화 및 성능 최적화 지원"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "실제 환경 기반 대규모 AI서비스 검증을 위한 국산 NPU 실증 인프라 구축·고도화",
                "LLM·이기종 AI반도체 혼용 등 대형 AI 상용서비스 수용 인프라 목표"
              ]
            },
            {
              "id": "target",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "국산 NPU 기반 AI 실증 인프라 단계적 확충 및 운영단위 모듈→클러스터 수준 고도화",
                "LLM·이기종 AI반도체 혼용 등 대규모 AI 상용서비스 실증 대응 인프라 환경 제공",
                "구축 인프라 기반 최신 AI서비스 실증 4건 지원",
                "최신 AI서비스 정상구동 검증·성능 개선용 테스트 환경 제공"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "국산 AI반도체에 대한 다양한 AI서비스 적용을 통한 활용 가능성·성능 검증",
                "서버·엣지 반도체 중심 기능·성능 테스트 및 도입 레퍼런스 확보 지원"
              ]
            },
            {
              "id": "target",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "국산 AI반도체 기반 응용실증 환경 구축 및 보드·서버·엣지 환경 개선 지원",
                "응용서비스 적용·기능·성능 점검을 통한 우수사례 확보",
                "실증환경 자체검증 및 국가공인시험인증기관 연계 제3자 검증 지원",
                "수요기업 도입 검토용 바우처·실증 연계 지원"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "시장 수요 연계 대규모 실증 추진을 통한 국산 AI반도체 조기 상용화 지원",
                "성능 검증을 넘어 초기 수요시장 형성·도입 확산까지 포괄하는 지원 범위 확대"
              ]
            },
            {
              "id": "target",
            ...
            },
            {
              ...
              "label": "지원내용",
              "content": [
                "AI데이터센터·온디바이스 AI 등 주요 수요분야 연계 대규모 실증 지원",
                "기술검증 중심에서 수요창출·조기 상용화 중심으로의 사업 구조 확대",
                "AI컴퓨팅 실증 인프라·사업화 적시 지원·AX 디바이스 실증 연계 허브 기능",
                "실증 결과 기반 시장진입·제품화 연계 지원"
              ]
            },
            {
              "id": "schedule",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "시장 활용·산업 수요 기반 AI 디바이스의 국산 AI반도체 기반 개발·전환·확산",
                "정규·미니트랙 분리 운영 및 응용실증 성과의 제품화·확산 연계"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "공공영역 중심 온디바이스 AI 서비스 대규모 적용사례 창출을 통한 국산 NPU 확산 촉진",
                "지자체 현안 연계 재난·치안·안전 등 생활밀착형 영역 서비스 개발·실증 동시 추진"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "생활·안전 분야 AX 전환 촉진을 위한 AI 서비스·응용제품 기업 대상 신속 상용화·개발 지원",
                "기존 AX 전환부터 신규 제품·서비스 개발까지 전주기 상용화 목표"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "상용 AI서비스 대상 GPU→국산 NPU 인프라 전환 및 실제 운영환경 검증",
                "의료·농업·에너지·도시 등 주요 분야 국산 NPU 적용성·확산 가능성 확보 중심"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "국산 NPU·AI서비스 패키지형 해외 수요처 실증 및 레퍼런스 확보 지원",
                "아시아·태평양 중심 유럽·중동까지 확장 추진 글로벌 진출형 사업"
              ]
            },
            {
              "id": "target",
          ...
          "tabs": [
            {
              ...
              "label": "사업개요",
              "content": [
                "기술인력 부족 완화를 위한 필요 인재 발굴·연결 지원",
                "경진대회 중심 발굴 한계 보완 및 전문인력 관리기관·헤드헌트·채용솔루션 연계 강화"
              ]
            },
            {
              "id": "target",
